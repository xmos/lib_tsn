...
xCORE-200 General Purpose SliceKIT using the AVB/TSN library and interfaced to audio codecs using an I2S master interface.
...
.. figure:: images/hw_diagram.*
   ...
   Block diagram of the xCORE-200 General Purpose SliceKIT hardware relevant to AVB
...
.. table:: Key application files
  ...
  +-----------------------------------+-------------------------------------------------------------------------+
  | ``src/SLICEKIT-XL216.xn``         | XN target file for the xCORE-200 General Purpose SliceKIT. Describes    |
...
preprogrammed the OTP memory on the xCORE-200 General Purpose SliceKITs to contain a unique
...
The application note is designed to run on the XMOS xCORE-General Purpose Slice, Audio-PLL and Ethernet Slice.

.. figure:: images/xCORE-200-GPSliceKit.*
   :scale: 70%
   :align: center
   
   xCORE-200 General Purpose SliceKIT

A full overview of the hardware and its features is provide in the xCORE-200 General Purpose SliceKIT Hardware Manual.
...
#. Connect the xCORE-200 General Purpose SliceKIT to the Mac via the Ethernet port or Thunderbolt to Ethernet adapter.
...
#. The endpoint will enumerate in this list as *xCORE-200 General Purpose SliceKIT*. Select the checkbox to the left of the entry to connect
   the device.
...
.. nopoints::
  ...
  * xCore-200 General-purpose sliceKIT Board Hardware Manual  
