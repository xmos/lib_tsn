...
#define AEM_CONTROL_SIZE_LINEAR_INT8         1
#define AEM_CONTROL_SIZE_LINEAR_UINT8        1
#define AEM_CONTROL_SIZE_LINEAR_INT16        2
#define AEM_CONTROL_SIZE_LINEAR_UINT16       2
#define AEM_CONTROL_SIZE_LINEAR_INT32        4
#define AEM_CONTROL_SIZE_LINEAR_UINT32       4
#define AEM_CONTROL_SIZE_LINEAR_INT64        8
#define AEM_CONTROL_SIZE_LINEAR_UINT64       8
#define AEM_CONTROL_SIZE_LINEAR_FLOAT        4
#define AEM_CONTROL_SIZE_LINEAR_DOUBLE       8
#define AEM_CONTROL_SIZE_SELECTOR_INT8       1
#define AEM_CONTROL_SIZE_SELECTOR_UINT8      1
#define AEM_CONTROL_SIZE_SELECTOR_INT16      2
#define AEM_CONTROL_SIZE_SELECTOR_UINT16     2
#define AEM_CONTROL_SIZE_SELECTOR_INT32      4
#define AEM_CONTROL_SIZE_SELECTOR_UINT32     4
#define AEM_CONTROL_SIZE_SELECTOR_INT64      8
#define AEM_CONTROL_SIZE_SELECTOR_UINT64     8
#define AEM_CONTROL_SIZE_SELECTOR_FLOAT      4
#define AEM_CONTROL_SIZE_SELECTOR_DOUBLE     8
// #define AEM_CONTROL_SIZE_UTF8             S
#define AEM_CONTROL_SIZE_BODE_PLOT           12
#define AEM_CONTROL_SIZE_ARRAY_INT8          1
#define AEM_CONTROL_SIZE_ARRAY_UINT8         1
#define AEM_CONTROL_SIZE_ARRAY_INT16         2
#define AEM_CONTROL_SIZE_ARRAY_UINT16        2
#define AEM_CONTROL_SIZE_ARRAY_INT32         4
#define AEM_CONTROL_SIZE_ARRAY_UINT32        4
#define AEM_CONTROL_SIZE_ARRAY_INT64         8
#define AEM_CONTROL_SIZE_ARRAY_UINT64        8
#define AEM_CONTROL_SIZE_ARRAY_FLOAT         4
#define AEM_CONTROL_SIZE_ARRAY_DOUBLE        8
#define AEM_CONTROL_SIZE_SELECTOR_STRING     2
#define AEM_CONTROL_SIZE_SMPTE_TIME          10
#define AEM_CONTROL_SIZE_SAMPLE_RATE         4
#define AEM_CONTROL_SIZE_GPTP_TIME           10
// #define AEM_CONTROL_SIZE_VENDOR           U
